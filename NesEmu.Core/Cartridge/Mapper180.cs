...
public sealed class Mapper180 : Mapper
{
    private readonly MirroringMode _mirroring;
    private byte _prgBank;

    public Mapper180(byte[] prgRom, byte[] chrMemory, byte[] prgRam, MirroringMode mirroring, bool chrWritable)
    ...
    public override byte CpuRead(ushort address)
    {
        ...
        return address < 0xC000
            ? ReadPrg16(0, address - 0x8000)
            : ReadPrg16(_prgBank, address - 0xC000);
    }
